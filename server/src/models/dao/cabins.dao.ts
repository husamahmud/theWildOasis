...
export class CabinsDao {
   ...
   * @param {string} cabinNumber - The unique identifier of the cabin to be updated.
   ...
   * @param {string} cabinNumber - The unique identifier of the cabin to be retrieved.
   ...
   * @param {string} cabinNumber - The unique identifier of the cabin to be deleted.
